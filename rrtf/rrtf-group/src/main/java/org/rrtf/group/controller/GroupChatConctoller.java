...
public class GroupChatConctoller{
	 ...
	 */
	@RequestMapping("/add")
	public String add(int typeId,String groupName,String detail,String rule,int teacherId,Model model,int userId){
	...
	*/
	...
	public String find2(Model model, int id,int userId) {
	 ...
	 */
	@RequestMapping("/chat")
	public String chat(int id,Model model,int userId) {
	...
	public String findOne(Model model,int id,int no,int userId){
	...
	*/
	...
	public String mygroup(int userId,Model model,int no) {
		Pageable pageable=new PageRequest(no, 5);
	...
	public String delusr(int userId,int groupId,Model model) {
	...
	public String addgroup(int userId,int groupId,Model model){
		groupChatDao.addIntoGroup(userId, groupId);
		return find2(model, groupId,userId);
	}
	/*
	 * 管理员批量删除群成员
	*/
